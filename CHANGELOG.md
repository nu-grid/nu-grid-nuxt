...
* @tanstack/vue-table is no longer a dependency. Public types (row, column, cell, table and state types) are nu-grid's own rather than re-exports of TanStack's, so code importing those types from @tanstack/vue-table must import them from @nu-grid/nuxt instead. Row virtualization still uses @tanstack/vue-virtual, now a declared dependency.
...
* Enter key behavior ([0ffd8fd](https://github.com/nu-grid/nu-grid-nuxt/commit/0ffd8fd516b646b8d188d1519b2a50bf202a9b83))
...
* Internalize sorting and filtering ([30f735e](https://github.com/nu-grid/nu-grid-nuxt/commit/30f735eb4d47be00673b5debf25442e5048e6c24))
* Narrow column menus ([0ffd8fd](https://github.com/nu-grid/nu-grid-nuxt/commit/0ffd8fd516b646b8d188d1519b2a50bf202a9b83))
* Nugridselectmenu ([a8e286f](https://github.com/nu-grid/nu-grid-nuxt/commit/a8e286fa3d0032aa6d49a884047e41d999dde1ef))
* Replace TanStack Table with nu-grid's own grid engine ([7ab395c](https://github.com/nu-grid/nu-grid-nuxt/commit/7ab395c9e4c18fb981731e5999d6c5609cdd68be))
* Server side paging ([635527c](https://github.com/nu-grid/nu-grid-nuxt/commit/635527c245ce483c9ffd47fe3e21feeb27c56b6f))
* Sorting stability ([0ffd8fd](https://github.com/nu-grid/nu-grid-nuxt/commit/0ffd8fd516b646b8d188d1519b2a50bf202a9b83))
* Spreadsheet mode ([0ffd8fd](https://github.com/nu-grid/nu-grid-nuxt/commit/0ffd8fd516b646b8d188d1519b2a50bf202a9b83))
...
* Focus stealing ([fa20d3b](https://github.com/nu-grid/nu-grid-nuxt/commit/fa20d3b2c6f09c8c4cc372eef20b94b5e9493337))
...
* Make virtualization reactive ([f35c3ed](https://github.com/nu-grid/nu-grid-nuxt/commit/f35c3ede5c353a3da1a4fecb8773f27fb2ed1a93))
...
* Row focusing on sort change ([a823746](https://github.com/nu-grid/nu-grid-nuxt/commit/a8237464ba901b9275f9511e91fc4296cfd577e9))
...
* Skip uneditable rows ([39fe54b](https://github.com/nu-grid/nu-grid-nuxt/commit/39fe54b09c9b848de4b07f14dec988765aeb4f27))

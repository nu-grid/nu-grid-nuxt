---
title: Introduction
description: NuGrid is a powerful data grid component for Nuxt with virtualization, cell editing, and a built-in data engine.
navigation:
  icon: i-lucide-house
---

NuGrid is a feature-rich data grid component built for Nuxt applications. It combines a lightweight built-in engine with Nuxt UI components to provide a seamless, highly customizable grid experience.

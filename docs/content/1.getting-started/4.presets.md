...
**Configuration:**
- Focus mode: `cell` with first/last navigation, page step of 5
...
| `editable` | cell | enabled | sticky, auto-size: content | - |
| `kanban` | row | enabled, minimal keys | group, sticky | - |
| `forms` | cell + firstlast | enabled, single-click | native scrollbars, fill | - |

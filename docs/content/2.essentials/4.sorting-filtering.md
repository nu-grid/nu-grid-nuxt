...
NuGrid provides built-in sorting, filtering, and search capabilities.
...
import type { SortingState } from '#nu-grid/types'
...
```vue
<script setup lang="ts">
import type { ColumnFiltersState } from '#nu-grid/types'

...
export const nuGridThemeCompact = {
  ...
  slots: {
    ...
    colResizeHandle:
      'flex shrink-0 items-center justify-center w-3 cursor-col-resize select-none touch-none opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-200 relative z-10 hover:bg-blue-500/10 [&:hover_.col-resizer]:bg-blue-500/80',
